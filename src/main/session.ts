...
export interface ValidatedToken {
  login: string; clientId: string; userId: string; follows: boolean; whispers: boolean
  /** The three grants a saved account's token predates: read from the validation, never guessed. */
  emotes: boolean; blocks: boolean; chatColor: boolean
  expiresIn: number
}
