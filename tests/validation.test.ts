...
import { bufferMode, channelName, chatText, mediaUrl, notificationPreferences, playbackPreferences, qualityName } from '../src/shared/validation'
...
test('a broken setting does not take the channels down with it', () => {
  ...
  const saved = validatePreferences({ channels: ['zerator', 'antoinedaniel'], active: 'zerator', quality: 'best', playback: 'oui', notifications: 7 })
